...
# ground = p.loadURDF("models/krsri2024.urdf", basePosition=[-5, 0, 0.1], useFixedBase=True)
...
gait_slider = p.addUserDebugParameter("gait", 0.01, 20, 2)
...
while True:
    try:
        ...
        gait = p.readUserDebugParameter(gait_slider)
        ...
        for leg_index in range(6):  # Iterate over all 6 legs
            # Compute trajectory
            pos = generate_movement(t, gait, step_duration, body_movement, leg_index) #Pos akan menghasilkan array [x,y,z]
